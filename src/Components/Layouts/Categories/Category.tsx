...
//         <h3>Categories</h3>
//         <NavLink to="/category/women's clothing" className="category-link">
//           Women&apos;s Fashion
//         </NavLink>
//         <NavLink to="/category/men's clothing" className="category-link">
//           Men&apos;s Fashion
//         </NavLink>
//         <NavLink to="/category/electronics" className="category-link">
//           Electronics
//         </NavLink>
//         <NavLink to="/category/jewelery" className="category-link">
//           Jewelery
//         </NavLink>
//       </div>
//       <div>
